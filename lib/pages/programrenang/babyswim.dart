...
class BabySwimPage extends StatelessWidget {
  const BabySwimPage({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage('assets/images/babyswim.jpg'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      _infoRow(
                        ...
                        title: 'Apa?',
                        desc: 'Kelas khusus bayi dan balita untuk mengenalkan mereka pada air sejak dini dengan teknik yang aman dan menyenangkan.',
                      ...
                      _infoRow(
                        ...
                        title: 'Siapa?',
                        desc: 'Bayi dan balita dengan pendampingan orang tua.',
                      ...
                      _infoRow(
                        ...
                        title: 'Mengapa?',
                        desc: 'Membantu perkembangan motorik, keberanian, dan bonding dengan orang tua.',
              ...
              SizedBox(height: size.height * 0.04),
              // CTA atau info tambahan (opsional, bisa dihapus jika tidak perlu)
              Text(
                'Yuk, daftarkan buah hati Anda dan awali petualangan seru di air bersama Maestro Swim!',
                textAlign: TextAlign.center,
